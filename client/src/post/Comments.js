...
class Comments extends Component {
  ...
  render() {
    ...
    return (<div>
        <CardHeader
              avatar={
                <Avatar className={classes.smallAvatar} src={'/api/v1/users/photo/'+auth.isAuthenticated().user._id}/>
              }
              title={ <TextField
        ...
        { this.props.comments.map((item, i) => {
            return <CardHeader
                      avatar={
                        <Avatar className={classes.smallAvatar} src={'/api/v1/users/photo/'+item.postedBy._id}/>
                      }
